                ...
                <div class="card">
                  ...
                  <form id="oversightForm" class="form" action="#" method="post">
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="EntryID" value="<?php echo $ta_id; ?>">
                      <input type="hidden" name="SessionID" value="<?php echo $session_id; ?>">
                      <input type="hidden" name="CommitteeID" value="<?php echo $comm_id; ?>">

                      <button class="btn btn-outline-secondary mr-1 mb-1" type="submit" name="update" value="update">Update Travel Abroad Attendance</button>
                      <br/><br/>
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function(){
              ...
              $('#oversightForm').on('submit', function(e){
                  ...
                  var url2 = "<?php echo base_url(); ?>reports/api_update_benchmarking";
                  ...
                  $.ajax({
                      ...
                      success: function(response){
                          ...
                          if(response.message === "true"){
                            document.location.href = "<?php echo base_url(); ?>reports/edit_travel_abroad?id="+response.ft_id+"&commid="+response.comm_id;
                          }
                          else
                          {
                            $('#show_id').html("<div style='border:1px solid red;font-size: 11px;margin:0 auto !important;'> Failed to Update Travel Abroad Data. </div>")
                          }

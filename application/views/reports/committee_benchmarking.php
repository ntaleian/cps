                      ...
                      <table class="table table-striped dataex-html5-selectors">
                        ...
                        <tbody>
                          <?php
                            ...
                            if(!empty($benchmarking)){
                            $counter = 1; 
                            foreach($benchmarking as $bill){ ?>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <span data-toggle="modal" data-target="#edit_ta-<?php echo $bill['EntryID']; ?>"><button type="button" class="btn btn-outline-secondary" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="bx bxs-edit"></i></button></span>

                                    <a href="<?php echo base_url(); ?>reports/edit_travel_abroad?id=<?php echo $bill['EntryID']; ?>&commid=<?php echo $bill['CommitteeID']; ?>" class="btn btn-outline-secondary" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit MPs"><i class="bx bx-group"></i></a>

                                    <?php } ?>

                                    <span data-toggle="modal" data-target="#mps-<?php echo $bill['EntryID']; ?>"><button type="button" class="btn btn-outline-primary"aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="View MPs"><i class="bx bx-window-open"></i></button></span>

                                    <?php if($this->sys->check_access($bill['CommitteeID'])){ ?>

                                    <span data-toggle="modal" data-target="#delete_ta-<?php echo $bill['EntryID']; ?>"><button type="button" class="btn btn-outline-danger"aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="bx bx-x"></i></button></span>
                              ...
                              <!-- Modal Add Category -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <?php
                                                      $ct = 1;
                                                      $get = $this->db->query("SELECT mps.* FROM benchmarking_members LEFT JOIN mps ON benchmarking_members.MpID=mps.EntryID WHERE benchmarking_members.BenchmarkID='".$bill['EntryID']."'");
                                    ...
                                    <!-- END MODAL -->
                                     ...
                                     <!-- Modal Add Category -->
                                    <div class="modal fade none-border" id="edit_ta-<?php echo $bill['EntryID']; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><strong>Edit</strong> Travel Abroad</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" action="<?php echo base_url(); ?>reports/update_travel_abroad">
                                                        <div class="row">
                                                          ...
                                                          <input type="hidden" name="CommUrl" value="<?php echo $urlComm; ?>">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="control-label">Travel Abroad Title</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="control-label">Travel Abroad Amount</label>
                                                            ...
                                                            <div class="col-md-12">
                                                            <br/><br/>
                                                              <input type="submit" name="updatetas" value="Update Travel Abroad Details" class="btn btn-success mr-10 badge-pill font-14">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <!-- Modal Add Category -->
                                    <div class="modal fade none-border" id="delete_ta-<?php echo $bill['EntryID']; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><strong>Delete</strong> Travel Abroad</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">
                                                        <div class="row">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?php echo base_url(); ?>reports/delete_ta?id=<?php echo $bill['EntryID']; ?>&url=<?php echo $url; ?>&comm=<?php echo $urlComm; ?>" class="btn btn-danger mr-10 badge-pill font-14">Delete Travel Abroad</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

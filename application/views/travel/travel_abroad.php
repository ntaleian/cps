              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Add Travel Abroad</h4>
                  </div>
                  <div class="card-body">

                    <form method="get" action="<?php echo base_url(); ?>travel/travel_abroad_list" class="form">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 d-flex">
                        ...
                        <button type="submit" name="submit" value="submit" class="btn btn-primary mr-1">Proceed</button>

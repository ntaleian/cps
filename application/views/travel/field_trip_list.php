            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <form id="oversightForm" class="form" action="<?php echo base_url() ?>travel/add_oversight" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-3">
                        <div class="form-label-group">
                          <input type="text" id="VisitTitle" class="form-control" placeholder="Field Trip Description"
                            name="VisitTitle">
                          <label for="VisitTitle">Field Trip Description</label>
                        </div>
                      </div>
                      <div class="col-2">
                        <div class="form-label-group">
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function(){
              ...
              $('#oversightForm').on('submit', function(e){
                  ...
                  var url2 = "<?php echo base_url(); ?>travel/api_add_oversight";
                  ...
                  $.ajax({
                      ...
                      success: function(response){
                          ...
                          if(response.message === "true"){
                            document.location.href = "<?php echo base_url(); ?>travel/field_trip";
                          }
                          else
                          {
                            $('#show_id').html("<div style='border:1px solid red;font-size: 11px;margin:0 auto !important;'> Failed to Add Field Trip Data. </div>")
                          }

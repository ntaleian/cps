            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <form id="oversightForm" class="form" action="<?php echo base_url() ?>session_reports/travels_abroad_report" method="get">
                          ...
                          <?php
                            ...
                            foreach($committees as $committee){ ?>
                              <tr>
                                ...
                                ?>
                                <td><a href="<?php echo base_url(); ?>session_reports/view_committee_benchmarking?id=<?php echo $commID.$url_txt; ?>&committee=<?php echo $commTitle; ?>"><?php echo $committee['Title']; ?></a></td>
                                <td><?php echo $committee['Category']; ?></td>
                                <td><?php echo $committee['BenchmarkingCount']; ?></td>
